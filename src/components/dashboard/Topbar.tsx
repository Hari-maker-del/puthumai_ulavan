  ...
  return (
    <header className="sticky top-0 z-20 bg-white border-b border-gray-100 flex-shrink-0">
      <div className="flex items-center gap-3 px-4 sm:px-6 h-16">
        ...
        {/* Search */}
        <div className="flex min-w-0 flex-1 items-center gap-2 rounded-lg bg-gray-50 px-3 py-2 sm:flex-none sm:w-64 border border-gray-100">
        ...
        <button
          ...
          className="flex flex-shrink-0 items-center gap-2.5 rounded-lg hover:bg-gray-50 border border-gray-100 px-2.5 py-1.5 transition-colors"
          aria-label="Profile"
        >
          {avatarUrl ? (
