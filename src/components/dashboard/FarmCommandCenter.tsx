...
export default function FarmCommandCenter() {
  ...
  const generateBriefing = async () => {
    ...
    try {
      ...
      setBriefing('AI briefing is unavailable right now. Use the prioritized actions below, which are generated from the farm data that is available.');
    } finally {
  ...
  useEffect(() => { if (context) void generateBriefing(); }, [context]);
